...
qst1_list = ["Who are you", 'who are you', 'whats your name','what is your name', 'your name', 'Your name', 'What are you', 'what are you']
...
Love_list = ['i love you', 'I love you', 'Love you', 'love you','Love you hannah', 'love you Hannah','i love you hannah', 'I love you hannah']
hate_list = ['i hate you', 'I hate you', 'Hate you', 'hate you']
thank_list = ['thanks','thanks hannah','thank you','thank you hannah','thank you so much hannah', 'Thanks Hannah','Thank you Hannah','Thank you Hannah']
morning_list = ['good morning','very good morning','good morning hannah','morning hannah']
evening_list = ['good evening','very good evening','good evening hannah','evening hannah']
afternoon_list = ['good afternoon','very good afternoon','good afternoon hannah']
friend_list = ['meet my friend','meet my new friend']
msg_list = ['send message', 'messsage my friend', 'send message to my friend', 'send a message','send a message to my friend', 'message']
yt_list = ['play','open on youtube','open in youtube','play on YouTube','youtube']
joke_list = ['tell me a joke','tell joke','tell any joke']
read_list = ['read','read selected','read what was last copied']
time_list = ['what is the time','what time is it','tell time','tell me the time']
...
cam_list = ['open camera','launch camera', 'take a picture','click a picture']
storage_list = ['how much memory is used by device','what is storage usage of my device','how much memory stored in my laptop']
...
def Decide(listen):
    ...
    if listen in hi_List:
        ...
        SET_LOVE=["i love you too","i love you too, but as a friend", "sorry, i have a boyfriend and honestly you deserve someone better.","love you too"]
        ...
        Respond(sp.Popen("C:\Windows\SystemApps\Microsoft.Windows.FileExplorer_cw5n1h2txyewy"))


    elif listen not in msg_list or friend_list or hi_list or bye_list or morning_list or afternoon_list or evening_list or love_list or hate_list or qst1list or thank_list or slang_list or res_neg_list:
